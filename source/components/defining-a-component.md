...
```
Ember components are used to encapsulate markup and style into reuseable content. Components consist of two parts: a Javascript component file that defines behavior and its accompanying Handlebars template that defines the markup for the component's UI.
